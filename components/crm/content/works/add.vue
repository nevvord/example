<template>
    <b-container class="pt-4">
        ...
        <b-form @submit="upload">
            ...
            <b-tabs content-class="mt-3" active-nav-item-class="text-danger">
            ...
            <div class="bg-light p-3 border border-top-0 border-dark" v-html="$store.state.works.form.inner"></div>
            <!--HTML для страницы-->
